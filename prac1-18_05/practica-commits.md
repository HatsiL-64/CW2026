...
```
Nombre     : Lopez Rosas Hatsi Iain
GitHub     : https://github.com/HatsiL-64
Algo sobre mí : Me gustan las tortas de papa
```
...
**Qué hacer:** Se dormir se comer y se caminar  
...
> para reemplazar a bitkeepebitkeeper de código cerrado y dejó de darse gratis al proyecto Linux.
